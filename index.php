            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 bannerBox">
                        <h1>Winning Starts @ Wone</h1>
                        <div class="bannerPar">
                        <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dictum luctus interdum. Praesent bibendum lacus urna. Mauris tempus, tortor cursus tristique faucibus, velit eros laoreet enim.</h4>
                        </div>
                        
                        <div class="col-xs-12 col-sm-6 col-md-4 hme-sscrl">
                        
                            <a id="down-mc-btn" class="scroll btn-lg btn-success" data-speed="380" data-target="#ourgoogleservices" href="#ourgoogleservices">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                         <h2 class="text-center">Got Problems?</h2>
                        <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dictum luctus interdum.</p>
                            <div class="row text-center caseLogos">
                                <div class="col-sm-4 smallHeading"> 
                                    <img src="img/getting_outpaced.png" alt="Getting Outpaced"> 
                                    <p>GETTING OUTPACED</p>                           
                                </div>
                                <div class="col-sm-4 smallHeading">
                                    <img src="img/need_to_expand.png" alt="Want to Expand">  
                                    <p>NEED TO EXPAND</p>
                                </div>
                                <div class="col-sm-4 smallHeading">
